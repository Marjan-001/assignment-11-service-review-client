    ...
    return (
        <div >
            ...
            <div className="collapse ">
                ...
                <div className="collapse-title bg-rose-600 text-primary-content peer-checked:bg-rose-400 peer-checked:text-secondary-content">
                    Difference between SQL and NoSQL
                </div>
                <div className="collapse-content bg-primary text-primary-content peer-checked:bg-rose-400 peer-checked:text-secondary-content">
