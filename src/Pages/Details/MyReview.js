...
const MyReview = () => {
    ...
    useEffect(() => {
        fetch(`https://assignment-11-service-review-server.vercel.app/myreview?email=${user?.email}`,
    ...
    const handleDelete = id => {
        ...
        if (proceed) {
            fetch(`https://assignment-11-service-review-server.vercel.app/myreview/${id}`, {
                method: 'DELETE'
            })
                .then(res => res.json())
                .then(data => {
